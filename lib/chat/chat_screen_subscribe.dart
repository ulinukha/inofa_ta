...
class _ChatScreenSubState extends State<ChatScreenSub> {
  ...
  postChat() async {
    final response = await http.post(
        BaseUrl.postChat + _loginUser.user.id_pengguna.toString(),
        headers: {
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, i) {
          return Container(
              ...
              child: Row(
                mainAxisAlignment: _listChat[i].pengguna_id == -1
                    ? MainAxisAlignment.center
                    : _listChat[i].pengguna_id == _loginUser.user.id_pengguna
                ...
                children: <Widget>[
                      ...
                      : _listChat[i].pengguna_id == _loginUser.user.id_pengguna
                          ...
                          : Container(
                              child: CircleAvatar(
                                radius: 20,
                                backgroundImage:
                                    NetworkImage(_listChat[i].profile_picture),
                              ),
                            ),
                  SizedBox(
                    width: 8,
                  ...
                  Container(
                    ...
                    decoration: new BoxDecoration(
                        color: _listChat[i].pengguna_id ==
                                _loginUser.user.id_pengguna
                            ? Color(0xff2968E2)
                            : Colors.black12,
                        borderRadius: new BorderRadius.only(
                          topLeft: Radius.circular(8),
                          topRight: Radius.circular(8),
                          bottomLeft: _listChat[i].pengguna_id == -1
                              ? Radius.circular(8)
                              : _listChat[i].pengguna_id ==
                                      _loginUser.user.id_pengguna
                                  ? Radius.circular(8)
                                  : Radius.circular(0),
                          bottomRight: _listChat[i].pengguna_id == -1
                              ? Radius.circular(8)
                              : _listChat[i].pengguna_id ==
                                      _loginUser.user.id_pengguna
                                  ? Radius.circular(0)
                    ...
                    child: Column(
                      crossAxisAlignment: _listChat[i].pengguna_id ==
                              _loginUser.user.id_pengguna
                  ...
                  Container(
                    ...
                    decoration: new BoxDecoration(
                        ...
                        borderRadius: new BorderRadius.only(
                          topLeft: Radius.circular(8),
                          topRight: Radius.circular(8),
                          bottomLeft: idUsers[i] ==
                                  _loginUser.user.id_pengguna.toString()
                              ? Radius.circular(8)
                              : Radius.circular(0),
                          bottomRight: idUsers[i] ==
                                  _loginUser.user.id_pengguna.toString()
                              ? Radius.circular(0)
                              : Radius.circular(8),
                        )),
                          ...
                          if (textController.text.isNotEmpty) {
                            socketIO.sendMessage(
                                ...
                                json.encode({
                                  'content': textController.text,
                                  'display_name':
                                      _loginUser.user.display_name.toString(),
                                  'id_pengguna':
                                      _loginUser.user.id_pengguna.toString(),
                                  'profile_picture':
                                      _loginUser.user.id_pengguna.toString(),
                            ...
                            this.setState(() => idUsers
                                .add(_loginUser.user.id_pengguna.toString()));
                            this.setState(() => userNames
                                .add(_loginUser.user.display_name.toString()));
                            this.setState(() => profilePicture.add(
                                _loginUser.user.profile_picture.toString()));
                            postChat();
                            textController.text = '';
                            scrollController.animateTo(
                              scrollController.position.maxScrollExtent,
