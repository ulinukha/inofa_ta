class UserModels{
  int id_pengguna;       String id;
  String display_name;   String profile_picture;
  String pendidikan;     String email;
  String tgl_lahir;      String website;
  String no_telp;        String short_desc;
  ...
  UserModels({
    ...
    this.short_desc,      this.longitude,   this.latitude,
    this.rating,          this.status,      this.id_pendidikan,
  });
