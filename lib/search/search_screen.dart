...
class SearchScreen extends StatefulWidget {
  ...
  SearchScreen({Key key, this.userData}) : super(key: key);
  @override
  ...
  onSearch(text) async {
    ...
    _listInovasi.forEach((f) {
      if (f.judul.contains(text) ||
          f.kategori.contains(text) ||
          f.display_name.contains(text)) _listInovasiSearch.add(f);
    });
    setState(() {});
  }
                                ...
                                children: <Widget>[
                                        ...
                                        Material(
                                          child: Image.network(
                                            'http://192.168.43.10:8000/' +
                                                _listInovasiSearch[i].thumbnail,
                                            width: 400.0,
                                            height: 100.0,
                                            fit: BoxFit.cover,
                                          ),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          _listInovasiSearch[i].description,
                                          maxLines:
                                              _listInovasiSearch[i].isSelected
                                                  ? _listInovasiSearch[i]
                                                      .description
                                                      .length
                                                  : 2,
