...
class _ChatState extends State<Chat>{
  ...
  Future<Null> _getListInovasiInCreate()async{
    ...
    final response = await http.get(BaseUrl.getInovasiInCreate+email,
    headers: {
  ...
  Future<Null> _getListInovasiInJoin()async{
    ...
    _listInovasi.clear();
    final response = await http.get(BaseUrl.getInovasiInJoin+email,
    headers: {
      'Authorization': 'Bearer '+ token,
    });
    final data = jsonDecode(response.body);
    ...
    return new Scaffold(
      ...
      _listInovasi.length == 0 && _listCreateInovasi.length == 0? 
        Center(
          child: Column(
            children: <Widget>[
              Image.asset('images/EmptyGroup.png', width: 300,),
              SizedBox(height: 15),
              Text('Tidak ada pesan', style: 
                TextStyle(
                  fontSize: 18,
        ...
        itemBuilder: (context, i){
          return Container(
            child: GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(builder: (context) => ChatScreen(inovasis: _listCreateInovasi[i])));
              },
              child: Container(
                width: 400,
                      ...
                      Container(
                        ...
                        child: Row(
                          children: <Widget> [
                            Material(
                              child: Image.network(
                                  'http://192.168.20.102:8000/'+_listCreateInovasi[i].thumbnail,
                                  width: 55.0,
                                  height: 55.0,
                                  fit: BoxFit.cover,
                                ),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget> [
                                    Container(
                                      child: new Text(_listCreateInovasi[i].judul,
                                    ...
                                    // Row(
                                    //   children: <Widget> [
                                    //     Text(_listCreateInovasi[i].pengguna_id.toString(),
