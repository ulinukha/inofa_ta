...
class _NotifState extends State<Notif> {
  ...
  Future<Null> _getListInvitation() async {
    ...
    final response = await http.get(
        BaseUrl.listInvitedInovasi + _loginUser.user.id_pengguna.toString(),
        headers: {
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => RequestInvite(
                          dataInovasi: _listInvitation[i],
                          dataUser: _loginUser)));
                },
                child: Container(
                  width: 400,
                              ...
                              Container(
                                ...
                                child: Column(
                                    ...
                                    children: <Widget>[
                                      Container(
                                        child: new Text(
                                          'Seseorang mengundang anda pada inovasi ' +
                                              _listInvitation[i].judul,
                                          style: TextStyle(
                                              fontSize: 13,
