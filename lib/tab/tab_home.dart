...
class _HomeState extends State<Home>{
  ...
  // List<ListInovasi> _filterInovasi = [];
  ...
  Future<void> _getListInovasiBySkill()async{
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var token = prefs.getString('token');
    final response = await http.get(BaseUrl.getInovasiBySkill + _kemampuanUser[0].id_kemampuan.toString(),
    headers: {
      'Authorization': 'Bearer '+ token,
    });
  ...
  // filterInovasis(){
  //   _filterInovasi = _listInovasi.where((element) => !_listInovasiBySkill.contains(element)).toList();
  //   print(_filterInovasi.length);
  // }
  ...
  Widget build(BuildContext context){
    return new Scaffold(
      ...
      appBar: AppBar(
        ...
        // centerTitle: true,
        elevation: 0.0,
        title: Text('Inofa', style: TextStyle(
          color: Colors.black,
          ),
        ),
      ),
      ...
      floatingActionButton: FloatingActionButton(
        child: Icon(Icons.add),
          ...
          onPressed: () {
            Navigator.push(
              context, MaterialPageRoute(builder: (context)=>AddIde(userData: _loginUser),
              ),
            );
          },
        ),
  ...
  showAll() {
    return Container(
      ...
      child: FlatButton(
        onPressed: () {
          Navigator.pushNamed(context, '/serchKategori');
        },
              ...
              child: RaisedButton(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    SizedBox(width: 10,),
                    Text("Cari ide..",
                      style: TextStyle(fontSize: 14, color: Color(0xff818182))),
                  ],
                ),
              ),
            ),
        ...
        itemBuilder: (context, i){
          return Container(
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context, MaterialPageRoute(builder: (context)=>IdeDetail(inovasis: _listInovasiBySkill[i],  userData: _loginUser),
                  ),
                );
              },
              child: Container(
                ...
                child: new Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget> [
                          ...
                          Material(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget> [
                                  Container(
                                    child: new Text(_listInovasiBySkill[i].judul,
                                  ...
                                  Row(
                                    children: <Widget> [
                                      Text(_listInovasiBySkill[i].display_name,
                                        style: TextStyle(fontSize: 12, color: Colors.grey),
                                      ),
                                      SizedBox(width: 15),
                                      Text(dateFormat.format(DateTime.parse(_listInovasiBySkill[i].created_at)),
                                        style: TextStyle(fontSize: 12, color: Colors.grey),
                                      ),
                                    ]
                                  ),
                      ...
                      Container(
                        child: Stack(
                          children: <Widget>[
                            Material(
                              child: Image.network(
                                  'http://192.168.20.102:8000/'+_listInovasiBySkill[i].thumbnail,
                                  width: 400.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                                ),
                      ...
                      Container(
                        width: 400,
                          child: Text(_listInovasiBySkill[i].tagline
                      ...
                      Container(
                        width: 400,
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(_listInovasiBySkill[i].description,
                                maxLines: _listInovasiBySkill[i].isSelected ? _listInovasiBySkill[i].description.length : 2,
                              ...
                              InkWell(
                                onTap: (){
                                  setState(() {
                                    _listInovasiBySkill[i].isSelected = !_listInovasiBySkill[i].isSelected;
                                  });
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: <Widget>[
                                    _listInovasiBySkill[i].isSelected ? Text("Perkecil",style: TextStyle(color: Colors.grey),) :  Text("Lanjut",style: TextStyle(color: Colors.grey))
                                  ],
                                ),
                              )
                            ],
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          SizedBox(width: 5),
                          Text(_listInovasiBySkill[i].jumlah.toString()),
                        ],
                      )
                    ]
                  ),
        ...
        itemBuilder: (context, i){
          return Container(
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context, MaterialPageRoute(builder: (context)=>IdeDetail(inovasis: _listInovasi[i],  userData: _loginUser),
                  ),
                );
              },
              child: Container(
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget> [
                                  ...
                                  Row(
                                    children: <Widget> [
                                      Text(_listInovasi[i].display_name,
                                        style: TextStyle(fontSize: 12, color: Colors.grey),
                                      ),
                                      SizedBox(width: 15),
                      ...
                      Container(
                        child: Stack(
                          children: <Widget>[
                            Material(
                              child: Image.network(
                                  'http://192.168.20.102:8000/'+_listInovasi[i].thumbnail,
                                  width: 400.0,
                                  height: 100.0,
                                  fit: BoxFit.cover,
                                ),
                      ...
                      Container(
                        width: 400,
                          child: Column(
                            ...
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: <Widget>[
                              Text(_listInovasi[i].description,
                                maxLines: _listInovasi[i].isSelected ? _listInovasi[i].description.length : 2,
                                textAlign: TextAlign.start,
                                overflow: TextOverflow.ellipsis, 
                                style: TextStyle(fontSize: 12.0, color: Colors.black54),
                              ),
                              InkWell(
                                onTap: (){
                                  setState(() {
                                    _listInovasi[i].isSelected = !_listInovasi[i].isSelected;
                                  });
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.end,
                                  children: <Widget>[
                                    _listInovasi[i].isSelected ? Text("Perkecil",style: TextStyle(color: Colors.grey),) :  Text("Lanjut",style: TextStyle(color: Colors.grey))
                                  ],
                                ),
                              )
                            ],
